            ...
            >
                ...
                <div className="px-6 pb-6">
                    <div className="mb-6">
                        ...
                        >
                            Form untuk mendaftarkan pasien baru dan mengambil
                            nomor antrean sesuai cluster atau dokter tujuan.
                        </p>
                    </div>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="cluster1">
                                            Cluster 1
                                        </option>
                                        <option value="cluster2">
                                            Cluster 2
                                        </option>
                                        <option value="cluster3">
                                            Cluster 3
                                        </option>
                                        <option value="cluster4">
                                            Cluster 4
                                        </option>
                                    </select>
                                </div>
                                <div className="grid grid-cols-2 gap-4 pt-2">
                                    <button
                                        ...
                                        onClick={handleReset}
                                        onMouseDown={() =>
                                            setIsBatalPressed(true)
                                        }
                                        onMouseUp={() =>
                                            setIsBatalPressed(false)
                                        }
                                        onMouseLeave={() =>
                                            setIsBatalPressed(false)
                                        }
                                    ...
                                    <button
                                        type="submit"
                                        onMouseDown={() =>
                                            setIsAntreanPressed(true)
                                        }
                                        onMouseUp={() =>
                                            setIsAntreanPressed(false)
                                        }
                                        onMouseLeave={() =>
                                            setIsAntreanPressed(false)
                                        }
