...
export default function DaftarAntreanPage() {
  ...
  const handlePanggil = useCallback((id: number) => {
    console.log("Panggil:", id);
    // Add call logic here
  }, []);

  const handleLewati = useCallback((id: number) => {
    console.log("Lewati:", id);
    // Add skip logic here
  }, []);
                      ...
                      <td className="px-6 py-4 align-middle">
                        <div className="flex items-center justify-center gap-1 flex-wrap">
                          <button
                            ...
                            className="px-3 py-2 rounded-lg text-xs font-medium transition-all duration-150 flex-1 min-w-max"
                            style={{
                          ...
                          <button
                            onClick={() => console.log("Selesai:", item.id)}
                            className="px-3 py-2 rounded-lg text-xs font-medium transition-all duration-150 flex-1 min-w-max"
                            style={{
