    ...
    <div className="flex h-screen">
      ...
      >
        ...
        >
          ...
          >
            Ingin Menampilkan Display Antrean?
          </h2>
          ...
          <div className="flex gap-3 flex-col sm:flex-row">
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.borderColor = isDark ? "#404145" : "#DC2626";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.borderColor = isDark ? "#2A2A2A" : "#D1D5DB";
              }}
            >
            ...
            <button
              ...
              onMouseLeave={(e) => {
                e.currentTarget.style.backgroundColor = isDark ? "#313337" : "#DC2626";
              }}
            >
              Tampilkan Sekarang
            </button>
